    ...
    return (
      <div className="container index-container" style={{ paddingTop: '15px' }}>
        <div className="end-container">
          <h1 style={{ textAlign: 'center', color: '#55419c' }}>
            HackDavis ends in:{' '}
          </h1>
        </div>
        <div
        ...
        <div className="timeline-container">
          <Timeline
            dataSource={{ sourceType: 'profile', screenName: 'hack_davis' }}
...
export const pageQuery = graphql`
  query index {
    allMarkdownRemark(
      filter: { frontmatter: { link: { eq: "Schedule" } } }
      sort: { fields: [frontmatter___start, frontmatter___end], order: ASC }
    ) {
      edges {
        node {
          frontmatter {
